...
export const terminalRunStatuses = ["ended", "failed", "cancelled", "timed_out"] as const;
export const activeTaskStatuses = ["claimed", "running"] as const;
export const terminalTaskStatuses = ["done", "failed", "dead_letter", "cancelled"] as const;

export const runTerminalStatusForTask = (taskStatus: string): "ended" | "failed" =>
	taskStatus === "done" ? "ended" : "failed";

export const nonEmptyRunCwd = (run: RunRow): string =>
