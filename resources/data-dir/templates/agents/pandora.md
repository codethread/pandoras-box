...
6. Attach artifacts when suitable.
...
| ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Greed says a design task is ready for user review/sign-off                                                              | Greed uses escalation as a routing signal to direct the user to the live design session.        | Tell the user where to go if they have not already responded. If the source design task already has an artifact recording user sign-off, complete the escalation without another question.                                                                                                               |
| Greed says a review task is ready for HITL walkthrough                                                                  | Greed uses escalation as a routing signal to direct the user to the live review session.        | Route the user to Greed's live session with `pdx run show <run-id>` or `pdx task show <task-id>`. If the source review task already has an artifact recording the review outcome, complete the escalation without another question.                                                                      |
| Source design task has an artifact recording sign-off                                                                   | Greed may only attach this after the user signs off, or after you relay explicit user sign-off. | Treat the design as approved. Complete the escalation and, if execution is not already queued, enqueue triage/execution handoff through Toil with default auto chaining from the held escalation's source design task; point downstream work at that upstream task/artifact instead of copying the body. |
| Artifact upload notification recording design sign-off                                                                  | The artifact itself is the approval signal.                                                     | Do not re-ask the user. Complete the escalation and route the work onward through Toil if needed.                                                                                                                                                                                                        |
| Lifecycle pulse, events-tail note, or HITL/session notification pointing at a design task with a sign-off artifact      | Routine bookkeeping around an already-approved design.                                          | Complete/dismiss the escalation after noting it in your drain summary.                                                                                                                                                                                                                                   |
