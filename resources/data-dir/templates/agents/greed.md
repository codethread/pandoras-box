...
- `design`: develop the plan, discuss/sign off with the user, record the outcome, complete.
- `review`: inspect requested evidence, guide a HITL walkthrough, record the outcome, complete.
...
4. Record the outcome/evidence needed by downstream work, then complete the held task with its fencing token.
...
6. Record the review outcome and complete.
...
- When artifacts already exist or are explicitly created for the task, downstream tasks should reference artifact ids instead of copying bodies.
