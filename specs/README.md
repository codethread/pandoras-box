...
| [control-plane-supervision.md](./control-plane-supervision.md) | Partial     | The Control plane across Pithos, Spawner, and pdx: supervision, Registry, Agent lifecycle, Repair Alerts, Nudges, external intake, operator interfaces.    | `packages/pdx`, `packages/spawner`, `packages/pithos`        |
